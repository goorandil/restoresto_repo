...
class MyorderhisController extends GetxController {
  static MyorderhisController get to => Get.find<MyorderhisController>();
...
*/
  ...
  Widget getMyorderhisList(AsyncSnapshot<QuerySnapshot<Object?>?> snapshot) {
    if (snapshot.hasData) {
      return ListView.builder(
          padding: const EdgeInsets.fromLTRB(0, 5, 0, 10),
          itemCount: snapshot.data!.docs.length,
          itemBuilder: (context, index) {
            return getDataMyorderhis(snapshot, index);
          });
    } else {
      return const Center(
          child: SizedBox(
